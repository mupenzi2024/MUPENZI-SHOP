...
.card {
    ...
    <title>electronic materials online Shopping</title>
...
$stmt = $conn->prepare("SELECT file_name, product_name, product_category, description, price FROM products WHERE product_category='electronic'");
$stmt->execute();
