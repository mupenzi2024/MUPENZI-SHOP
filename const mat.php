...
.card {
    ...
    <title>construction materials online Shopping</title>
...
$stmt = $conn->prepare("SELECT file_name, product_name, product_category, description, price FROM products WHERE product_category='construction materials'");
$stmt->execute();
